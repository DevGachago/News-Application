...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Login.this, BecomeMember.class));
            }
        });
                        ...
                        if (user != null) {
                            ...
                            usersRef.child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    Users userData = snapshot.getValue(Users.class); // Use Users class
                                    if (userData != null && userData.isVerified()) {
                                        ...
                                        Toast.makeText(Login.this, "User not verified. Please contact the admin.", Toast.LENGTH_SHORT).show();
                                    }
                                }
